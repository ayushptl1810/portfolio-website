        ...
        <div className="text-center">
          ...
          >
            <motion.button
              ...
              className="group relative px-12 py-6 bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl text-white text-xl font-semibold overflow-hidden shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 cursor-pointer"
