                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-4 text-gray-300 text-sm leading-relaxed font-body max-w-prose mx-auto">
                    <p>
                      ...
                      creating elegant, user-centric web applications. My
                      journey in tech started with curiosity and has evolved
                      into a deep appreciation for clean code and innovative
                      solutions.
                    </p>
                    <p>
